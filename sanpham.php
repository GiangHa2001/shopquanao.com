                    ...
                    <div class="row row-cols-1 row-cols-md-5 g-4">
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <img src="/shopquanao.com/uploads/<?= htmlspecialchars($sp['image_filename'] ?? 'no-image.png') ?>"
                                    class="card-img-top" alt="Ảnh sản phẩm">
                                <div class="card-body">
                                    <h5 class="card-title"><?= htmlspecialchars($sp['product_name']) ?></h5>
                                    <p class="card-text text-danger">
                                        <?= number_format($sp['product_price'], 0, ',', '.') ?> đ</p>
                                    <div class="d-flex gap-2 justify-content-between">
                                        <a href="chi_tiet.php?product_id=<?= $sp['product_id'] ?>"
